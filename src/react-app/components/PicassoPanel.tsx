    ...
    <div className="flex flex-col h-full bg-zinc-900/80">
      ...
      <div className="p-4 border-b border-zinc-800/50">
        <div className="flex items-center gap-2 mb-2">
          <div className="w-8 h-8 bg-gradient-to-br from-teal-400 to-cyan-300 rounded-lg flex items-center justify-center">
      ...
      {/* Processing overlay */}
      {isGenerating && (
        <div className="p-4 bg-teal-400/10 border-b border-teal-400/20">
            ...
            <div key={idx} className="space-y-2">
              {message.type === 'user' ? (
                <div className="flex justify-end">
                  <div className="bg-gradient-to-r from-teal-400 to-cyan-300 rounded-lg px-3 py-2 max-w-[85%]">
                  ...
                  <div className={`bg-zinc-800 rounded-lg p-3 space-y-2 ${message.error ? 'border border-red-500/30' : ''}`}>
                    ...
                    {message.awaitingDimension && (
                      <div className="flex gap-2 mt-3">
                        ...
                        >
                          <div className="w-8 h-5 border-2 border-teal-300 rounded" />
                        ...
                        <button
                          ...
                          className="flex-1 flex flex-col items-center gap-1 px-3 py-2 bg-zinc-700 hover:bg-zinc-600 disabled:opacity-50 rounded-lg transition-colors"
                        >
                          <div className="w-5 h-8 border-2 border-teal-300 rounded" />
                        ...
                        <button
                          ...
                          className="flex-1 flex flex-col items-center gap-1 px-3 py-2 bg-zinc-700 hover:bg-zinc-600 disabled:opacity-50 rounded-lg transition-colors"
                        >
                          <div className="w-6 h-6 border-2 border-teal-300 rounded" />
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-zinc-800/50">
            ...
            <div className="absolute bottom-full left-0 right-0 mb-2 p-2 bg-zinc-800 border border-zinc-700 rounded-xl shadow-xl z-10 animate-in fade-in slide-in-from-bottom-2 duration-200">
              <div className="grid grid-cols-2 gap-1.5">
                {QUICK_ACTIONS.map((action, idx) => (
                  ...
                  >
                    <action.icon className="w-4 h-4 text-zinc-400 group-hover:text-teal-300 transition-colors flex-shrink-0" />
        ...
        <div className="bg-zinc-800 rounded-xl border border-zinc-700/50 focus-within:ring-2 focus-within:ring-teal-400/50 transition-all">
          {/* Textarea */}
          <textarea
            value={prompt}
          ...
          <div className="flex items-center justify-between px-2 pb-2">
            ...
            <button
              ...
              className="w-8 h-8 bg-gradient-to-r from-teal-400 to-cyan-300 disabled:from-zinc-700 disabled:to-zinc-700 rounded-lg flex items-center justify-center transition-all hover:shadow-lg hover:shadow-teal-400/50 disabled:shadow-none"
            >
              {isGenerating ? (
