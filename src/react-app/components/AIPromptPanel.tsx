  ...
  return (
    ...
    >
            ...
            <div key={idx} className="space-y-2">
              {message.type === 'user' ? (
                <div className="flex justify-end">
                  <div className="bg-gradient-to-r from-teal-500 to-cyan-500 rounded-lg px-3 py-2 max-w-[85%]">
                  ...
                  <div className="bg-zinc-800 rounded-lg p-3 space-y-2">
                    ...
                    {message.command && (
                      <div className="mt-2 space-y-2">
                        ...
                        <div className="bg-zinc-900 rounded p-2 font-mono text-xs text-teal-400 overflow-x-auto">
                          {message.command}
                        </div>
                        {message.applied ? (
                          ...
                          <button
                            ...
                            className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 disabled:from-zinc-700 disabled:to-zinc-700 rounded-lg text-xs font-medium transition-all"
                          >
                            {isApplying ? (
                              <>
                                <Loader2 className="w-3 h-3 animate-spin" />
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-zinc-800/50">
            ...
            <div className="absolute bottom-full left-0 right-0 mb-2 p-2 bg-zinc-800 border border-zinc-700 rounded-xl shadow-xl z-10 animate-in fade-in slide-in-from-bottom-2 duration-200">
              <div className="grid grid-cols-2 gap-1.5">
                {suggestions.map((suggestion, idx) => (
                  ...
                  >
                    <suggestion.icon className="w-4 h-4 text-zinc-400 group-hover:text-teal-400 transition-colors flex-shrink-0" />
        ...
        {(selectedReferences.length > 0 || timeRange || attachedAssets.length > 0) && (
          <div className="flex flex-wrap gap-1.5 mb-2">
            ...
            {selectedReferences.map((ref, idx) => (
              <div
                key={idx}
                className="flex items-center gap-1 px-2 py-1 bg-teal-500/20 text-teal-300 rounded-md text-xs"
              >
                ...
                <button
                  ...
                  className="ml-0.5 hover:text-teal-100"
                >
                  <X className="w-3 h-3" />
                </button>
              </div>
        ...
        <div className="bg-zinc-800 rounded-xl border border-zinc-700/50 focus-within:ring-2 focus-within:ring-teal-500/50 transition-all">
          {/* Textarea */}
          <textarea
            value={prompt}
          ...
          <div className="flex items-center justify-between px-2 pb-2">
                  ...
                  <div className="absolute bottom-full left-0 mb-2 w-56 p-3 bg-zinc-800 border border-zinc-700 rounded-xl shadow-xl z-20 animate-in fade-in slide-in-from-bottom-2 duration-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          placeholder="0:00"
                          className="flex-1 px-2 py-1.5 bg-zinc-700 border border-zinc-600 rounded text-xs text-white placeholder:text-zinc-500 focus:outline-none focus:ring-1 focus:ring-teal-500"
                        />
                      </div>
                      <div className="flex items-center gap-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="flex-1 px-2 py-1.5 bg-teal-500 hover:bg-teal-600 rounded text-xs text-white font-medium transition-colors"
                      >
                        Apply
                      </button>
                    </div>
            ...
            <button
              ...
              className="w-8 h-8 bg-gradient-to-r from-teal-500 to-cyan-500 disabled:from-zinc-700 disabled:to-zinc-700 rounded-lg flex items-center justify-center transition-all hover:shadow-lg hover:shadow-teal-500/50 disabled:shadow-none"
            >
              {isProcessing ? (
