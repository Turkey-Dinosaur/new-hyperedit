        ...
        <div className="p-4 border-b border-zinc-800">
          <form onSubmit={handleSearch} className="flex gap-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2.5 bg-teal-600 hover:bg-teal-500 disabled:opacity-50 text-white font-medium rounded-lg transition-colors"
            >
              Search
            </button>
            <button
              ...
              {error.includes('GIPHY_API_KEY') && (
                <div className="text-zinc-400 text-sm">
                  ...
                  <ol className="text-left inline-block">
                    <li>1. Get a free API key at <a href="https://developers.giphy.com/" target="_blank" rel="noopener" className="text-teal-400 hover:underline">developers.giphy.com</a></li>
            ...
            <>
              ...
              <div className="grid grid-cols-3 md:grid-cols-4 gap-3">
                {gifs.map((gif) => (
                  <div
                    key={gif.id}
                    className="group relative aspect-video bg-zinc-800 rounded-lg overflow-hidden cursor-pointer hover:ring-2 hover:ring-teal-500 transition-all"
